...
Config.reward = 100                             -- Reward for one treasure. If you want to use a item reward then modify Pay() function under /server/functions.lua
...
Config.FakeLocationChance = 25                   -- Chance to randomize a location and not spawn any treasure. [FAKE LOCATION WITHOUT TREASURE]
...
Config.Clothes = {
    male = {
        ...
        ["t-shirt"] = {clotheId = 0, variation = 0},
