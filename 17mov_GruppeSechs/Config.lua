...
Config.Reward = 500                    -- Complete transport will give the team this value. 
...
Config.PossibleLoots = {
    ...
    [1] = { loot = 2500, chance = 100 },
    [2] = { loot = 5000, chance = 50 },
    [3] = { loot = 7500, chance = 25 },
    [4] = { loot = 10000, chance = 12.5 },
}
