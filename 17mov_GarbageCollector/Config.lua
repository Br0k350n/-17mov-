...
Config.VersionCheck = {
    ...
    DisplayAsciiArt = false,                         -- Set to false if you don't want to display ascii art in console
    DisplayChangelog = false,                        -- Should display changelog in console?
...
Config.Price = 4                                    -- Price per one bag inside trashmaster. 100 is maximum so full trash = 200$ / partyCount
...
Config.EnableExploitFix = false                      -- Set to true to enable checking if any players is withing x meters while bag is being picked.
...
Config.JobCooldown = 3 * 60 -- 10 * 60              -- 0 minutes cooldown between making jobs (in brackets there's example for 10 minutes)
