...
Config.JobCooldown = 2 * 60 -- 10 * 60            -- 0 minutes cooldown between making jobs (in brackets there's example for 10 minutes)
...
Config.Price = 3            -- Means $3 per one window, so the full reward depends on current location
